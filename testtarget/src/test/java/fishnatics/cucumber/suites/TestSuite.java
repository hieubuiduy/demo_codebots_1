 ...
 */
package fishnatics.cucumber.suites;
...
@CucumberOptions(
		...
		glue = {
				...
				"fishnatics.cucumber.registry",
				"fishnatics.cucumber.hooks",
				"fishnatics.cucumber.stepdefs"
		},
		features = {
				// % protected region % [Add any additional features here] off begin
				// % protected region % [Add any additional features here] end
				"src/test/java/fishnatics/cucumber/features"
		},
		plugin = {
