 ...
 */
package fishnatics.configs.security.services;

import fishnatics.configs.security.helpers.AnonymousHelper;
import fishnatics.configs.security.repositories.UserRepository;
import fishnatics.configs.security.exceptions.*;
import fishnatics.entities.*;
import fishnatics.lib.services.email.*;
import fishnatics.lib.token.models.TokenEntity;
import fishnatics.lib.token.services.TokenService;
 ...
 * to {@link fishnatics.services.UserService}. Whereas {@link fishnatics.services.UserService} is simply used as a base
