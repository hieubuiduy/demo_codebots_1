...
package fishnatics.configs.security.repositories;

import fishnatics.entities.UserEntity;
 ...
 * {@link fishnatics.repositories.UserRepository} since we want to be able to query all user tables at once
 ...
 * against all user types at once, which is not possible for {@link fishnatics.repositories.UserRepository}.
 */
@Repository
public interface UserRepository extends fishnatics.repositories.UserRepository<UserEntity> {
